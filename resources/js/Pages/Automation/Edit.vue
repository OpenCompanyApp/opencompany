<template>
  <div class="h-full flex flex-col overflow-hidden bg-neutral-50 dark:bg-[#181818]">
    ...
    <template v-else>
      ...
      >
        This legacy script is disabled. Rewrite it as synchronous JavaScript and save it to pin the automation to quickjs-v1 before running.
      </div>
      ...
      <div class="flex-1 min-h-0 flex">
        ...
        <div class="flex-1 min-w-0">
          <MonacoEditor
            v-model="content"
            :language="form.executionType === 'script' ? 'javascript' : 'markdown'"
      ...
      <div class="flex items-center h-6 px-3 shrink-0 border-t border-neutral-200 dark:border-neutral-700/60 bg-white dark:bg-[#1f1f1f] text-[11px] text-neutral-400 dark:text-neutral-500 gap-3 select-none">
        <span class="font-medium">{{ form.executionType === 'script' ? 'JavaScript / QuickJS v1' : 'Markdown' }}</span>
...
const legacyScript = computed(() => automationData.value?.executionType === 'script'
  && automationData.value?.scriptRuntime !== 'quickjs-v1')
