<template>
  ...
  >
    <div
      v-if="open"
      class="fixed inset-y-0 right-0 w-full md:w-[480px] bg-white dark:bg-neutral-900 border-l border-neutral-200 dark:border-neutral-700 shadow-xl z-50 flex flex-col"
    >
      <!-- Header -->
      <div class="px-4 py-3 border-b border-neutral-200 dark:border-neutral-700 flex items-center justify-between shrink-0">
        <div class="flex items-center gap-3">
          ...
          >
            <span :class="['w-1.5 h-1.5 rounded-full animate-pulse', statusDots[task.status]]" />
      ...
      <!-- Actions Footer -->
      <div class="px-4 py-3 border-t border-neutral-200 dark:border-neutral-700 flex items-center justify-between shrink-0">
