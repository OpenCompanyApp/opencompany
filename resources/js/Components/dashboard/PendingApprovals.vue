    ...
    return () => h('div', {
      ...
      h('div', { class: 'flex-1 space-y-2' }, [
        h('div', { class: 'flex items-center gap-2' }, [
          ...
          h(Skeleton, { customClass: 'h-4 w-16 rounded' }),
        ]),
        h(Skeleton, { customClass: 'h-3 w-48' }),
        h(Skeleton, { customClass: 'h-3 w-24' }),
      ]),
      h('div', { class: 'flex gap-2' }, [
        h(Skeleton, { customClass: 'h-8 w-20 rounded-lg' }),
        h(Skeleton, { customClass: 'h-8 w-16 rounded-lg' }),
      ]),
    ])
  },
})
