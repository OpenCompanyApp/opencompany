---
name: "source-command-video"
description: "Produce a polished product video/commercial in Apple keynote style"
---

# source-command-video

Use this skill when the user asks to run the migrated source command `video`.
...
Reusable assets live in `.Codex/video-assets/`:
...
- Font: Lexend (`.Codex/video-assets/Lexend.ttf`)
...
fluidsynth -ni -F /tmp/oc-video/music/soundtrack.wav -r 44100 \
  .Codex/video-assets/soundfont.sf2 /tmp/oc-video/music/soundtrack.mid
```
...
- Reference: `.Codex/video-assets/compose.py`
...
See `.Codex/video-assets/generate_frames_v2.py` for the full reference implementation.
