 ...
 * scheduled prompt or runtime-pinned JavaScript workflows.
 */
class AutomationsToolProvider implements BuiltInToolProvider
{
    ...
    public function groupMeta(): array
    {
        return [
            ...
            'description' => 'Scheduled automations. "prompt" uses an agent; "script" runs validated synchronous JavaScript on quickjs-v1. Use code_read_doc for APIs.',
        ];
    }
    ...
    public function tools(): array
    {
        return [
            ...
            'create_automation' => [
                ...
                'description' => 'Create a prompt automation or a validated quickjs-v1 JavaScript automation.',
                'icon' => 'ph:lightning',
            ],
            'update_automation' => [
    ...
    public function createTool(string $class, User $agent, array $context = []): Tool
    {
        return match ($class) {
            ...
            UpdateAutomation::class => new $class($agent, app(QuickJsSandboxService::class)),
