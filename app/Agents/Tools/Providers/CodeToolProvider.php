 ...
 *
 * Agents inspect generated docs before running JavaScript; the
...
class CodeToolProvider implements BuiltInToolProvider
{
    ...
    public function groupMeta(): array
    {
        return [
            ...
            'description' => 'QuickJS Code Mode discovery, validation, and execution',
        ];
    }
    ...
    public function tools(): array
    {
        return [
            ...
            'code_exec' => [
                ...
                'description' => 'Validate or execute synchronous JavaScript in QuickJS after discovering APIs with code_read_doc.',
                'icon' => 'ph:play',
            ],
        ];
    }
    ...
    public function createTool(string $class, User $agent, array $context = []): Tool
    {
        ...
        return match ($class) {
            ...
            CodeExec::class => new CodeExec(app(QuickJsSandboxService::class), $toolRegistry, app(CodeApiDocGenerator::class), $agent),
