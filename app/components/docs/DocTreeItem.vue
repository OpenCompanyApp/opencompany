  ...
  >
    ...
    <Transition name="drop-indicator">
      <div
        ...
        class="absolute left-0 right-0 top-0 h-0.5 bg-olympus-primary z-10 rounded-full shadow-[0_0_8px_rgba(var(--olympus-primary-rgb),0.5)]"
    ...
    >
      ...
      >
        ...
        >
          <div class="flex items-center gap-2 text-olympus-text-muted">
        ...
        <div
          ...
          :style="{ paddingLeft: `${8 + (level + 1) * 20}px` }"
        >
          <div class="flex items-center gap-2 text-olympus-text-subtle">
    ...
    <Transition name="drop-indicator">
      <div
        ...
        class="absolute left-0 right-0 bottom-0 h-0.5 bg-olympus-primary z-10 rounded-full shadow-[0_0_8px_rgba(var(--olympus-primary-rgb),0.5)]"
        :style="{ marginLeft: `${8 + level * 20}px` }"
      />
    </Transition>
    ...
    <Transition name="drop-inside">
      <div
        ...
        class="absolute inset-0 rounded-lg border-2 border-dashed border-olympus-primary bg-olympus-primary/5 pointer-events-none z-5"
...
.doc-tree-children--with-line::before {
  ...
  background: linear-gradient(
    to bottom,
    oklch(var(--olympus-border)) 0%,
    oklch(var(--olympus-border)) 50%,
    transparent 100%
  );
  opacity: 0.5;
}
...
@keyframes selectPulse {
  0%, 100% {
    box-shadow: 0 0 0 0 oklch(var(--olympus-primary) / 0);
  }
  50% {
    box-shadow: 0 0 0 4px oklch(var(--olympus-primary) / 0.15);
  }
}
