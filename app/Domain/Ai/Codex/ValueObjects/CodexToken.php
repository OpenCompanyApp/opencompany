...
namespace App\Domain\Ai\Codex\ValueObjects;

use DateTimeImmutable;
use DateTimeInterface;

/**
 * Immutable representation of a ChatGPT/Codex OAuth token set.
 *
 * Token strings remain encrypted at rest by the model layer. This object exists
 * only in memory while resolving auth headers for Codex runtime calls.
 */
