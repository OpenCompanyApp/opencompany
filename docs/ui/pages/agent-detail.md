...
Clicking a task navigates through the generated task detail route helper.
```
...
- **Message button** links through the generated message route helper (redirects to unified chat)
